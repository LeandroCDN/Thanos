    ...
    <div className="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden">
      ...
      {openPositions.length === 0 ? (
        <div className="flex items-center justify-center h-24 text-gray-600 text-sm">
          ...
          button on a whitelisted pair to open one.
        </div>
      ) : (
                  ...
                  <tr key={pos.id} className="hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="px-3 py-2">
                      <div className="flex items-center justify-end gap-1">
                        <button
                          disabled
                          title="Live close from active positions is not connected yet"
                          className="px-2 py-1 rounded text-[11px] font-bold tracking-wide bg-gray-800 text-gray-600 cursor-not-allowed transition-colors"
                        >
                          CLOSE
                        </button>
                        <button
